...
def make_neighborhoods(
    ...
    Returns
    -------
    unitcell_neighborhood: list[list[int]]
        The neighborhood of unit cells needed to evaluate basis functions involving
        sites in the origin unit cell. Each element is a list containing the
        ``[i,j,k]`` indices of a neighbor unit cell.
